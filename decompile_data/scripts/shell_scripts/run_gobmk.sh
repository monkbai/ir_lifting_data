...
# TEST 1
specBin=gobmk_base.amd64-m32-gcc42-nn
input=input/gobmk/13x13.tst
lift $specBin < $input --quiet --mode gtp

# TEST 2
specBin=gobmk_base.amd64-m32-gcc42-nn
input=input/gobmk/nngs.tst
lift $specBin < $input --quiet --mode gtp

# TEST 3 
specBin=gobmk_base.amd64-m32-gcc42-nn
input=input/gobmk/score2.tst
lift $specBin < $input --quiet --mode gtp
